...
test_set_1_label = np.loadtxt("./Dataset/Dataset1/test_with_label_1.csv", delimiter=',', dtype=np.int32)
test_feature_lb_1 = test_set_1[:,:-1]
test_target_lb_1 = test_set_1[:,-1]
...
validation_feature_2 = validation_set_1[:,:-1]
validation_target_2 = validation_set_1[:,-1]
test_set_2 = np.loadtxt("./Dataset/Dataset2/test_no_label_2.csv", skiprows=1, delimiter=",")